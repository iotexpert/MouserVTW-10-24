...
const uint8_t gatt_database[] = // Define GATT database
{
    ...
    PRIMARY_SERVICE_UUID128 (HDLS_REMOTE, __UUID_REMOTE),

        /* Characteristic 'paddle' */
        CHARACTERISTIC_UUID128_WRITABLE (HDLC_REMOTE_PADDLE, HDLC_REMOTE_PADDLE_VALUE,
            __UUID_REMOTE_PADDLE, LEGATTDB_CHAR_PROP_READ | LEGATTDB_CHAR_PROP_WRITE,
